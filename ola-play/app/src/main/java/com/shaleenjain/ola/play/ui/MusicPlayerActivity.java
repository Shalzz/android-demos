...
public class MusicPlayerActivity extends BaseActivity
    ...
    private static final String SAVED_MEDIA_ID="com.shaleenjain.ola.play.MEDIA_ID";
    private static final String FRAGMENT_TAG = "uamp_list_container";

    public static final String EXTRA_START_FULLSCREEN =
            "com.shaleenjain.ola.play.EXTRA_START_FULLSCREEN";
    ...
    public static final String EXTRA_CURRENT_MEDIA_DESCRIPTION =
        "com.shaleenjain.ola.play.CURRENT_MEDIA_DESCRIPTION";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem searchItem = menu.findItem(R.id.media_search_menu_item);
