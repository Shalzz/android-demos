...
import com.shaleenjain.ola.play.data.model.MusicProvider;
import com.shaleenjain.ola.play.playback.CastPlayback;
import com.shaleenjain.ola.play.playback.LocalPlayback;
import com.shaleenjain.ola.play.playback.Playback;
import com.shaleenjain.ola.play.playback.PlaybackManager;
import com.shaleenjain.ola.play.playback.QueueManager;
import com.shaleenjain.ola.play.ui.NowPlayingActivity;
import com.shaleenjain.ola.play.utils.CarHelper;
import com.shaleenjain.ola.play.utils.LogHelper;
import com.shaleenjain.ola.play.utils.TvHelper;
import com.shaleenjain.ola.play.utils.WearHelper;
...
import static com.shaleenjain.ola.play.utils.MediaIDHelper.MEDIA_ID_EMPTY_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "com.shaleenjain.ola.play.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "com.shaleenjain.ola.play.ACTION_CMD";
    ...
    public void onCreate() {
        ...
        Application.get(this).getComponent().inject(this);

        mMusicProvider = new MusicProvider(mDataManager);
        ...
        QueueManager queueManager = new QueueManager(mMusicProvider, getResources(), mAlbumArt,
        ...
        try {
            mMediaNotificationManager = new MediaNotificationManager(this, mAlbumArt);
    ...
    public BrowserRoot onGetRoot(@NonNull String clientPackageName, int clientUid,
        ...
        return new BrowserRoot(MEDIA_ID_ALL, null);
    }
