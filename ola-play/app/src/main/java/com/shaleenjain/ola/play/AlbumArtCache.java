...
import com.shaleenjain.ola.play.utils.BitmapHelper;
...
public final class AlbumArtCache {
    ...
    @Inject
    AlbumArtCache(@ApplicationContext Context context) {
        mContext = context;
    ...
    public void fetch(final String artUrl, final FetchListener listener) {
        Bitmap[] bitmaps = mCache.get(artUrl);
        if (bitmaps != null) {
            ...
            protected Bitmap[] doInBackground(Void[] objects) {
                ...
                try {
                    ...
                    Bitmap bitmap = Glide.
                            ...
                            load(artUrl).
                            asBitmap().
                            into(MAX_ART_WIDTH, MAX_ART_HEIGHT).
                            get();
                    ...
                    Bitmap icon = Glide.
                            ...
                            load(artUrl).
                            asBitmap().
                            into(MAX_ART_WIDTH_ICON, MAX_ART_HEIGHT_ICON).
                            get();
