...
package com.shaleenjain.ola.play.utils;
...
import com.shaleenjain.ola.play.VoiceSearchParams;
...
import static com.shaleenjain.ola.play.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
public class QueueHelper {
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueue(String mediaId,
        ...
        if (categoryType.equals(MEDIA_ID_ALL)) {
