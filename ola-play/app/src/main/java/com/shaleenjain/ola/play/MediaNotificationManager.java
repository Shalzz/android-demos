...
import com.shaleenjain.ola.play.ui.MusicPlayerActivity;
import com.shaleenjain.ola.play.utils.LogHelper;
import com.shaleenjain.ola.play.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private static final String CHANNEL_ID = "com.shaleenjain.ola.play.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "com.shaleenjain.ola.play.pause";
    public static final String ACTION_PLAY = "com.shaleenjain.ola.play.play";
    public static final String ACTION_PREV = "com.shaleenjain.ola.play.prev";
    public static final String ACTION_NEXT = "com.shaleenjain.ola.play.next";
    public static final String ACTION_STOP = "com.shaleenjain.ola.play.stop";
    public static final String ACTION_STOP_CASTING = "com.shaleenjain.ola.play.stop_cast";
    ...
    private void fetchBitmapFromURLAsync(final String bitmapUrl,
        ...
        cache.fetch(bitmapUrl, new AlbumArtCache.FetchListener() {
            @Override
