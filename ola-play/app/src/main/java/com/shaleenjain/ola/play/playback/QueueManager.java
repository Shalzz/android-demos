...
package com.shaleenjain.ola.play.playback;
...
import com.shaleenjain.ola.play.AlbumArtCache;
...
import com.shaleenjain.ola.play.utils.QueueHelper;
...
public class QueueManager {
    ...
    public void updateMetadata() {
        ...
        if (metadata.getDescription().getIconBitmap() == null &&
            ...
            mAlbumArt.fetch(albumUri, new AlbumArtCache.FetchListener() {
                @Override
