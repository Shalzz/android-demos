...
public class MediaItemViewHolder {
    ...
    static View setupListView(Activity activity, View convertView, ViewGroup parent,
                              MediaBrowserCompat.MediaItem item, MediaBrowserFragment.PopUpMenuListener listener) {
        ...
        if (convertView == null) {
            ...
            holder.mImageView = (ImageView) convertView.findViewById(R.id.cover_image);
            holder.mTitleView = (TextView) convertView.findViewById(R.id.text_name);
            holder.mDescriptionView = (TextView) convertView.findViewById(R.id.text_artist);
            holder.mImageButton = convertView.findViewById(R.id.imageButton);
        ...
        holder.mImageButton.setOnClickListener(v -> {
            listener.onPopUpMenuClicked(v, item.getMediaId());
        });
        ...
        else if (cachedState == null || cachedState != state) {
